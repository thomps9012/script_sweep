const BASE_URL = "https://thomps9012.github.io/script_sweep/endpoints";
export const ERRORS = {
  MALFORMED_BODY: {
    status: "BAD REQUEST",
    code: 400,
    ...
    documentation_link: `${BASE_URL}/classify`,
    second_documentation_link: `${BASE_URL}/organize`,
  },
  ID_NOT_FOUND: {
    status: "NOT FOUND",
    code: 404,
    message: "No script was found with that ID",
    documentation_link: `${BASE_URL}/scripts`,
  },
  UNIMPLEMENTED: {
  ...
  DUPLICATE_KEY: {
    ...
    documentation_link: `${BASE_URL}/authorization`,
  },
  NO_EMAIL: {
    status: "BAD REQUEST",
    code: 400,
